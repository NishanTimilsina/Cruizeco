...
- (instancetype)initWithTitle:(NSString *)title
    ...
    if ([super init]) {
        ...
        //                textField.layer.borderColor= [UIColor colorWithRed:237/255.0 green:237/255.0 blue:237/255.0 alpha:1.0].CGColor;
        //            }
        //
        //        }
    }
...
- (void)setupTitle {
    ...
    if (pTitle) {
        if (!titleLabel) {
            ...
            [titleLabel setTextColor:[UIColor colorWithRed:18/255.0 green:168/255.0 blue:171/255.0 alpha:1.0] /*#546595*/];
        }
...
- (void)setupTextFields {
    ...
    if (pTextFieldPlaceholderArray) {
        ...
        for (int i = 0; i < [pTextFieldPlaceholderArray count]; i++) {
            if (i == 0) {
                textField1 = [self textViewForPost];//[self textFieldWithPlaceholder:pTextFieldPlaceholderArray[i] numberOfField:1];
            }
            else if (i == 1) {
        ...
        if ([pTextFieldPlaceholderArray count] == 1) {
            [textField1 setFrame:CGRectMake(8, titleHeights + 24, popupView.frame.size.width - 16, textFieldHeight*6)];
...
- (void)setupButtons {
    ...
    if (pCancelTitle) {
        ...
        if (!cancelBtn) {
            ...
            [cancelBtn.layer setCornerRadius:0.0];
    ...
    if (pSuccessTitle) {
        ...
        if (!successBtn) {
            ...
            [successBtn.layer setCornerRadius:0.0];
...
/** ADDED BY KK */
-(UITextView*) textViewForPost {
    UITextView* textView= [[UITextView alloc] initWithFrame:CGRectMake(0.0, 0.0 , 200.0, 10.0)];

    
    [textView setBackgroundColor:[UIColor whiteColor]];
    textView.layer.borderWidth= 2.0;
    textView.layer.borderColor= [UIColor colorWithRed:237/255.0 green:237/255.0 blue:237/255.0 alpha:1.0].CGColor;
    return textView;
...
- (UITextField *)textFieldWithPlaceholder:(NSString *)placeholderText numberOfField:(int)num {
    ...
    [textField setFont:[UIFont fontWithName:@"HelveticaNeue" size:12.0f]];
